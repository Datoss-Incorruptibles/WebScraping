    ...
    if CANDIDATO["HOJA_VIDA_ENCRIPTADA"] == "VACIO":
      ...
      for CandEducacionSuperior in responseJSON["d"]:
          objCandEducacionSuperior = {
              ...
              "DNI":CANDIDATO["DNI"],
              "NOMBRE_COMPLETO":repr(CANDIDATO["NOMBRE_COMPLETO"]),
              "objTipoEstudioBE_intTipo":CandEducacionSuperior["objTipoEstudioBE"]["intTipo"],  # 4 PostGrado # 3 Universitario # 1 Tecnico  
              "strNombreCarrera":repr(CandEducacionSuperior["strNombreCarrera"]), 
              "strNombreEstudio":repr(CandEducacionSuperior["strNombreEstudio"]),
              "strNombreCentro":repr(CandEducacionSuperior["strNombreCentro"]),
              "strFgConcluido":repr(CandEducacionSuperior["strFgConcluido"]), # 1 concluido
              "strTipoGrado":repr(CandEducacionSuperior["strTipoGrado"]),
              "strOtroTipoGrado":repr(CandEducacionSuperior["strOtroTipoGrado"]),
