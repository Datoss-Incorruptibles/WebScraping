...
# with open('../PlataformaElectoral/EleGenerales2021/GetExpedientesLista.json','r', encoding='utf-8' ) as jsonfile:
#     doc = jsonfile.read()
...
# with open('../PlataformaElectoral/EleGenerales2021/GetCandidatos.json','r', encoding='utf-8' ) as jsonfile:
#     doc = jsonfile.read()
#     arrayCandidatos = json.loads(str(doc))
#     count = 0
...
# with open('../PlataformaElectoral/EleGenerales2021/ProcesosElectorales.json','r', encoding='utf-8' ) as jsonfile:
#     doc = jsonfile.read()
#     arrayCandidatos = json.loads(str(doc))
...
#   SET ruta_archivo= 'https://aplicaciones007.jne.gob.pe/srop_publico/Consulta/Simbolo/GetSimbolo/%20{row}' \
#   WHERE id={count};"
#   )
#   count += 1
#   con.commit()
