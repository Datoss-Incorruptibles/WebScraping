...
def insert_candidato_estudio_target():
    try: 
        ...
        query = """
            ...
            when strconcluidoeduuni = '0' and stregresadoeduuni = '0' and UPPER(strcarrerauni) like '%BACHILLER%' and straniobachiller <> '' THEN 'CONCLUIDO' 
            when strconcluidoeduuni = '0' and stregresadoeduuni = '0' and UPPER(strcarrerauni) not like '%BACHILLER%' and straniobachiller <> '' THEN 'UNIVERSITARIO'
            when strconcluidoeduuni = '0' and stregresadoeduuni = '0' and UPPER(strcarrerauni) not like '%BACHILLER%' and straniobachiller = '' THEN 'NO CONCLUIDO'
            when strconcluidoeduuni = '0' and stregresadoeduuni = '1' and UPPER(strcarrerauni) not like '%BACHILLER%' and straniobachiller <> '' THEN 'UNIVERSITARIO'
            when strconcluidoeduuni = '0' and stregresadoeduuni = '1' and UPPER(strcarrerauni) not like '%BACHILLER%' and straniobachiller = '' THEN 'EGRESADO'
            ...
            when strconcluidoeduuni = '1' and stregresadoeduuni = '0' and UPPER(strcarrerauni) like '%BACHILLER%' and straniobachiller <> '' THEN 'BACHILLER'
            when strconcluidoeduuni = '1' and stregresadoeduuni = '0' and UPPER(strcarrerauni) not like '%BACHILLER%' and straniobachiller <> '' THEN 'UNIVERSITARIO'
            ...
            when strconcluidoeduuni = '1' and stregresadoeduuni = '1' and UPPER(strcarrerauni) like '%BACHILLER%' and straniobachiller = '' THEN 'BACHILLER'
            when strconcluidoeduuni = '1' and stregresadoeduuni = '1' and UPPER(strcarrerauni) like '%MASTER%' and straniobachiller <> '' THEN 'MAGISTER'
            ...
            when strconcluidoeduuni = '1' and stregresadoeduuni = '1' and UPPER(strcarrerauni) not like '%BACHILLER%' and straniobachiller = '' THEN 'UNIVERSITARIO'
            when strconcluidoeduuni = '1' and stregresadoeduuni = '2' and UPPER(strcarrerauni) like '%BACHILLER%' and straniobachiller <> '' THEN 'BACHILLER'
            ...
            when strconcluidoeduuni = '2' and stregresadoeduuni = '1' and UPPER(strcarrerauni) not like '%BACHILLER%' and straniobachiller = '' THEN 'EGRESADO'
            when strconcluidoeduuni = '2' and stregresadoeduuni = '2' and UPPER(strcarrerauni) like '%BACHILLER%' and straniobachiller <> '' THEN 'EGRESADO'
